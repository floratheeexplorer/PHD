...
for f in file_names:        
        ...
        extension_names = ['_stops', '_nonidentical_stops' , '_stop_ratio']
...
#                print(loc.head())
                ...
                search_logic_names = ['orders_spans']
...
#print to csv
file = open('20190328_greedy_span_stop_assignment_all_files_56_SKUs.csv', 'w')
with file:
